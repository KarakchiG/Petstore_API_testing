...
# class TestPetClass:
#
#     def test_pet_find_by_id(self, pet_service):
#         response = pet_service.get_pet(1)
#         data = response.json()
#         assert response.status_code == 200
#         assert data["id"] == 1
#
#
#     def test_find_pets_by_status(self, pet_service):
#         searched_status = "available"
#         response = pet_service.get_pets_by_status(searched_status)
#         data = response.json()
#         assert response.status_code == 200
...
#             assert pet["status"] == searched_status
#
#     def test_create_pet(self, pet_service, fake_pet):
#         pet_id = fake_pet["id"]
...
#         assert data["id"] == pet_id
#
#     def test_update_fake_pet(self, pet_service, fake_pet):
#         pet_id = fake_pet["id"]
#         response = pet_service.create_pet(json=fake_pet)
#         data = response.json()
#         assert response.status_code == 200
...
#         assert data["status"] == "unavailable"
#
#     def test_delete_pet(self, pet_service, fake_pet):
#         pet_id = fake_pet["id"]
#         response = pet_service.create_pet(json=fake_pet)
#         data = response.json()
#         assert response.status_code == 200
