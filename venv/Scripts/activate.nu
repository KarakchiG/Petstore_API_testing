...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\kharakchi\PycharmProjects\git-training\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\kharakchi\PycharmProjects\git-training\venv\Scripts\deactivate.nu'
